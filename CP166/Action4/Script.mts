...
Sub SeleccionarPlan()
	...
	If JavaWindow("Ejecutivo de interacción").JavaDialog("Mensaje").JavaStaticText("No existen ofertas elegibles").Exist = True Then
		...
		JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &"Mensaje.png", True
		imagenToWord "Mensaje",RutaEvidencias() &"Mensaje.png"
		Reporter.ReportEvent micFail, DataTable("s_Resultado", dtlocalSheet), DataTable("s_Detalle", dtlocalSheet)
...
Sub AltaExpress()
	...
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Alta Express (Para WALTHER").JavaList("Compromiso").Select "0"
	wait 1
...
Sub EnviarPago()
	...
	wait 2 @@ hightlight id_;_2640397_;_script infofile_;_ZIP::ssf15.xml_;_
